...
import 'package:row_calculator/core/historyV2/presentation/history.dart'
    as _i13;
...
import 'package:row_calculator/core/historyV2/presentation/internal/two_two_history_details_page.dart'
    as _i12;
import 'package:row_calculator/core/presentation/features.dart' as _i8;
...
abstract class $AppRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    TwoInputView.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i2.TwoInputView(),
      );
    },
    TwoFeatureRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i3.TwoFeaturePage(),
      );
    },
    ThreeFeatureRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i4.ThreeFeaturePage(),
      );
    },
    ...
    SpeedStrokesRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i7.SpeedStrokesPage(),
      );
    },
    FeatureRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.FeaturePage(),
      );
    },
    FeatureListRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i8.FeatureListPage(),
      );
    },
    OneHistoryDetailsRoute.name: (routeData) {
      ...
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i9.OneHistoryDetailsPage(
          key: args.key,
          id: args.id,
        ),
      );
    ...
    ThreeHistoryDetailsRoute.name: (routeData) {
      ...
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i10.ThreeHistoryDetailsPage(
          key: args.key,
          id: args.id,
        ),
      );
    ...
    TwoOneHistoryDetailsRoute.name: (routeData) {
      ...
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i11.TwoOneHistoryDetailsPage(
          key: args.key,
          id: args.id,
        ),
      );
    ...
    TwoTwoHistoryDetailsRoute.name: (routeData) {
      ...
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i12.TwoTwoHistoryDetailsPage(
          key: args.key,
          id: args.id,
        ),
      );
    ...
    HistoryListRoute.name: (routeData) {
      return _i14.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i13.HistoryListPage(),
      );
    },
  };
}
